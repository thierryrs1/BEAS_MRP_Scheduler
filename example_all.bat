...
start /wait "" beas.exe server=NDB@cobrah:30013 db=SBO_COBRA_PRD user=manager pw=B1admin@ /inservermode script="<cr_lf>object=ue_mrp=server<cr_lf>app=close<cr_lf>"
